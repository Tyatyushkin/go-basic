...
### HW - 10
1. Добавлен метод POST /api/v1/albums для создания альбома
2. Добавлен метод GET /api/v1/albums для получения списка альбомов
3. Добавлен метод GET /api/v1/albums/{id} для получения альбома по id
4. Добавлен метод DELETE /api/v1/albums/{id} для удаления альбома по id
5. Добавлен метод PUT /api/v1/albums/{id} для обновления альбома по id
